...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"By Zeyu", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"2026毕业设计-车辆重识别系统", None))
        self.ToggleBotton.setText(QCoreApplication.translate("MainWindow", u"隐藏", None))
        self.HomeBotton.setText(QCoreApplication.translate("MainWindow", u"主页", None))
        self.DataManageButton.setText(QCoreApplication.translate("MainWindow", u"数据", None))
        self.DetectButton.setText(QCoreApplication.translate("MainWindow", u"检测", None))
        self.ReidButton.setText(QCoreApplication.translate("MainWindow", u"重识别", None))
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"车辆重识别系统", None))
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.detect_char_label.setText(QCoreApplication.translate("MainWindow", u"检测", None))
        self.detect_set_button.setText("")
        self.src_cam_button.setText(QCoreApplication.translate("MainWindow", u"摄像头", None))
        self.src_rtsp_button.setText(QCoreApplication.translate("MainWindow", u"视频流", None))
        self.src_file_button.setText(QCoreApplication.translate("MainWindow", u"本地文件", None))
        self.class_label.setText(QCoreApplication.translate("MainWindow", u"类别总数", None))
        self.class_num.setText("")
        self.target_label.setText(QCoreApplication.translate("MainWindow", u"目标总数", None))
        self.target_num.setText("")
        self.fps_label.setText(QCoreApplication.translate("MainWindow", u"帧率", None))
        ...
        self.save_res_button.setText(QCoreApplication.translate("MainWindow", u"保存视频/图片", None))
        ...
        self.explain.setText(QCoreApplication.translate("MainWindow", u"Welcome!", None))
        ...
        self.title_label_2.setText(QCoreApplication.translate("MainWindow", u"标题\uff1a", None))
        self.search_button_2.setText(QCoreApplication.translate("MainWindow", u"检索", None))

        self.reid_char_label.setText(QCoreApplication.translate("MainWindow", u"重识别", None))
        self.reid_set_button.setText("")
        self.target_label_3.setText(QCoreApplication.translate("MainWindow", u"选择目标", None))
        self.target_select_button.setText(QCoreApplication.translate("MainWindow", u"文件", None))
        self.src_cam_button_2.setText(QCoreApplication.translate("MainWindow", u"摄像头", None))
        self.src_rtsp_button_2.setText(QCoreApplication.translate("MainWindow", u"视频流", None))
        self.src_file_button_2.setText(QCoreApplication.translate("MainWindow", u"本地文件", None))
        self.class_label_2.setText(QCoreApplication.translate("MainWindow", u"类别总数", None))
        self.class_num_2.setText("")
        self.target_label_2.setText(QCoreApplication.translate("MainWindow", u"目标总数", None))
        self.target_num_2.setText("")
        self.fps_label_2.setText(QCoreApplication.translate("MainWindow", u"帧率", None))
        ...
        self.setting_label_2.setText(QCoreApplication.translate("MainWindow", u"设置", None))
