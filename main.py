...
class MainWindow(QMainWindow, Ui_MainWindow): #窗口函数
    ...
    def __init__(self, parent=None):
        ...
        UIFunctions.shadow_style(self, self.Target_QF_2, shadow_color)
        UIFunctions.shadow_style(self, self.Fps_QF_2, shadow_color)
    ...
    def set_custom_ui(self):
        # Modify the main background color (Dark Blue Gradient)
        self.Main_QF.setStyleSheet("QFrame#Main_QF{background-color: qlineargradient(x0:0, y0:0, x1:1, y1:1, stop:0 #141E30, stop:1 #243B55); border-radius: 10px;}")
        
        # Modify the text styles (White/Light Grey) and Content
        self.Title.setStyleSheet("color: #FFFFFF; font: 600 13pt 'Segoe UI Semibold';")
        self.Title.setText("Reid Demo")  # Change Top Left Title
        
        self.Author.setStyleSheet("color: #E0E0E0; font: italic 11pt 'Segoe UI';")
        ...
        logo_path = os.path.abspath("./img/logo.png").replace("\\", "/")
        if os.path.exists(logo_path):
            self.logo.setStyleSheet(f"image: url({logo_path}); border: 2px solid white; border-radius: 25px;")

        # Modify Right Side Settings Panel (Reid)
        # Change background to dark blue gradient to match Main_QF, preserving border radius
        self.prm_page_2.setStyleSheet("QFrame#prm_page_2{background-color: qlineargradient(x0:0, y0:0, x1:1, y1:1, stop:0 #141E30, stop:1 #243B55); border-top-left-radius: 30px; border-bottom-left-radius: 30px; border-top-right-radius: 0px; border-bottom-right-radius: 0px;}")

        # Modify Right Side Settings Panel (Detect)
        # Change background to dark blue gradient to match Main_QF, preserving border radius
        self.prm_page.setStyleSheet("QFrame#prm_page{background-color: qlineargradient(x0:0, y0:0, x1:1, y1:1, stop:0 #141E30, stop:1 #243B55); border-top-left-radius: 30px; border-bottom-left-radius: 30px; border-top-right-radius: 0px; border-bottom-right-radius: 0px;}")

        # Modify Status Indicators (Detect Page)
        status_style = "background-color: qlineargradient(x0:0, y0:0, x1:1, y1:1, stop:0 #141E30, stop:1 #243B55); border-radius: 10px; border: 1px solid #3E7EDE;"
        self.Class_QF.setStyleSheet(f"QFrame#Class_QF{{{status_style}}}")
        self.Target_QF.setStyleSheet(f"QFrame#Target_QF{{{status_style}}}")
        self.Fps_QF.setStyleSheet(f"QFrame#Fps_QF{{{status_style}}}")

        # Modify Status Indicators (Reid Page)
        self.Class_QF_2.setStyleSheet(f"QFrame#Class_QF_2{{{status_style}}}")
        self.Target_QF_2.setStyleSheet(f"QFrame#Target_QF_2{{{status_style}}}")
        self.Fps_QF_2.setStyleSheet(f"QFrame#Fps_QF_2{{{status_style}}}")

        # Modify Buttons (Detect and Reid)
        btn_style_template = """
        QPushButton{{
            background-image: url({icon});
            background-repeat: no-repeat;
            background-position: left 10px center;
            background-color: qlineargradient(x0:0, y0:0, x1:1, y1:0, stop:0 #141E30, stop:1 #243B55);
            border: 1px solid #3E7EDE;
            border-radius: 5px;
        ...
        # Detect Page Buttons
        self.src_cam_button.setStyleSheet(btn_style_template.format(icon=":/all/img/cam.png"))
        self.src_rtsp_button.setStyleSheet(btn_style_template.format(icon=":/all/img/RTSP.png"))
        self.src_file_button.setStyleSheet(btn_style_template.format(icon=":/all/img/file.png"))

        # Reid Page Buttons
        self.src_cam_button_2.setStyleSheet(btn_style_template.format(icon=":/all/img/cam.png"))
        self.src_rtsp_button_2.setStyleSheet(btn_style_template.format(icon=":/all/img/RTSP.png"))
        self.src_file_button_2.setStyleSheet(btn_style_template.format(icon=":/all/img/file.png"))
        self.target_select_button.setStyleSheet(btn_style_template.format(icon=":/all/img/file.png"))
